...
public class TestNoEmail {

    @Test
    public void сheckEmptyEmail() throws Exception {
...
//      Нажимаем Login в меню
        MobileElement loginMenuButton = (MobileElement) driver.findElementByXPath("//android.view.ViewGroup[@content-desc=\"Login\"]/android.widget.TextView");
